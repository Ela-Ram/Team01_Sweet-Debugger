...
Feature: Onboarding Scenarios without blood report
  ...
  #Examples:
  #| Scenario                           | Expected                                             |
  #| option is selectable               | Step 2 of 12                                         |
  #| message after selecting condition in step 1           | No worries, we're here to figure it out together! 🔍 |
  #| presence of back button in step 2 | back button in step 2                                |
  #| Step 2 heading is visible          | Which fabulous label fits you best?                  |
  #| step 2 sub text                    | Choose your gender                                   |
  #| Progress bar reflects Step 2 of 12 | Step 2 of 12                                         |
  #| gender options                     | Male 👨‍🦱,Female 👩‍🦰,Other ⚧️                            |
  # |step 2 progress is highlighted|Step 2 indicator highlighted|
  #
  ...
  #Examples:
  #|Expected|
  #|No worries, we're here to figure it out together! 🔍|
  #
  #-------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  #Examples:
  #| Scenario                           | Expected                                             |
  #| option is selectable               | Step 3 of 12                                         |
  #|Step 3 heading is visible|Age: own it, pick your number.|
  #|step 3 sub text|Please select your age|
  #|Progress bar reflects Step 3 of 12|Step 3 of 12|
  #|Back button is visible in step 3|Back button|
  #
  ...
  #
  #|options is displayed in step 3|18 to 100|years|
  #
  #@iframescrollable
  ...
  #Scenario Outline: Validate notification message for <Scenario>
    ...
    #When User selects "<Scenario>"  in step3
    #Then User should see "<Expected>" in step onboarding
#
    #Examples: 
      #| Scenario | Expected                       |
  ...
  #Examples:
  #| Scenario                           | Expected                                             |
  #| option is selectable               | Step 4 of 12                                         |
  #| Step 4 heading is visible|How close are you to the clouds?|
  #|step 4 sub text|Please enter your height|
   #|Progress bar reflects Step 4 of 12|  Step 4 of 12|
   #|Back button is visible in step 4|Back button should be visible in step 4|
    #
    #@2tabstoselectheight  
  ...
  #Examples:
  #| Scenario                            | Expected                                             |
  #|first tab height             |Centimeters                                         |
  #|second tab height						|Feet & Inches|
   #
   #
   #
   #
...
#
  ...
  #Scenario Outline: Validate notification message for <Scenario>
    ...
    #When User selects "<Scenario>"  in step4
    #Then User should see "<Expected>" in step onboarding
#
    #Examples: 
      #| Scenario | Expected                       |
      #| above 180cm    | How's the weather up there? (Sorry, we had to do it once) 🌤️|
      #|below 159cm|Good things come in smaller packages! 📦|
      #|160-179cm|Right in the middle - you can reach shelves AND fit in airplane seats! ✈️|
      #
...
#
 #@Onboardingstep5functional1
  #Scenario Outline: Validate notification message for weight option <Scenario>
    ...
    #When User selects "<Scenario>"  in step5
    #Then User should see "<Expected>" in step onboarding
#
    #Examples: 
      #| Scenario | Expected                       |
      #|less than 59    |Light as a feather! But don't worry, our recipes will keep you grounded. 🪶|
      #|between 60 -84|Perfectly balanced, as all things should be! ⚖️|
      #|greater than 85|More of you to love! And more energy to power those workouts. 💪|
 #
 #@Onboardingstep4functional2
  #Scenario Outline: Validate <Scenario>
    #Given User is in step5 Onboarding form without blood report
...
#
    #Examples: 
      #| Scenario | Expected                       |
      #|Verify dietary options selectable in step6 |Step 7 of 12|
      #|heading for Step7 is visible|What's your go-to food passport?|
      #|subtext displayed in Step7|To create a meal plan ,you'll enjoy please select your preferred cuisines!|
      #|progress bar displays Step 7 of 12|Step 7 of 12|
      #|Back button is visible in Step 7|Back button |
      #|Step 7 contains cuisine options|Indian 🍛,American🍔,Continental🥖,Mediterranean🥙,Asian🍜,Middle Eastern🥙,Mexican🌮🌿|
#
#
#@navbackfrom6to5
...
#
    #Examples: 
      #| Scenario | Expected                       |
      #|cuisine options are selectable in step7 |Step 8 of 12|
      #|heading for Step8 is visible|Allergic to any foods?|
      #|subtext displayed in Step8|Select yes if you have any food allergies|
      #|progress bar displays Step 8 of 12|Step 8 of 12|
      #|Back button is visible in Step 8|Back button |
      #|yes,no options are displayed in step 8| yes ✅ ,No❌|
      #
      #
   #@navbackfrom7to6
...
#
    #Examples: 
      #| Scenario | Expected                       |
      #|heading for Step 10 is visible|Any medical quirks worth mentioning?|
      #|subtext displayed in Step 10|Do you have any other medical conditions?|
      #|progress bar displays Step 10 of 12|Step 10 of 12|
      #|Back button is visible in Step 10|Back button |
...
#	 Examples: 
      #|Scenario | Expected                       |Yes/No|
      #|step 10 contains the list of other medical condition|High Blood Pressure, High Cholesterol,Heart Disease,PCOS(Polycystic Ovary Syndrome),Chronic kidney disease,Gastroesophageal reflux disease,Anemia,Hypothyroidism,Hyperthyroidism,None of the above|yes|
...
#
    #Examples: 
      ...
      #|progress bar displays Step 12 of 12|Step 12 of 12|Easy 🦋|
...
#
    #Examples: 
      ...
      #|the text below the input field|Please enter a value between 4.0 and 15.0|Easy 🦋|
      #|step 12 has continue button|continue button |Easy 🦋|
...
@Onboardingstep12nonfunctional2
  Scenario Outline: Validate <Scenario>
    ...
    Then User should see "<Expected>" for  "<Scenario>"
